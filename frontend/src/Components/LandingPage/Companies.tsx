...
const Companies = () => {
    return <div className="mt-20 pb-5">
        <div data-aos="zoom-out" className="text-4xl md-mx:text-3xl sm-mx:text-2xl xs-mx:text-xl text-center font-semibold mb-10 text-mine-shaft-100">Trusted By <span className="text-ocean-blue-400">1000+</span> Companies</div>
